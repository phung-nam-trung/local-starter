...
### Tasks
- [ ] **TK1: `repos.js` đọc workspace roots từ config (resolver), bỏ hardcode**
...
- [ ] **TK2: `store.js` workspaceRoots + IPC folder-picker + validate**
...
- [ ] **TK4: `platform.js` (OS util) + wire deps/indexer**
